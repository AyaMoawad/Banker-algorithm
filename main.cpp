...
int main()
{
    ...
    for (int i = 0; i < NProcesses; i++)
    {
        ...
        if(Processes[i][10]<Processes[0][7]&&Processes[i][11]<Processes[0][8]&&Processes[i][12]<Processes[0][9])
        {
    ...
    while(hpointer!=0)
    {
        for (int i = 0; i < hpointer; i++)
        {
           ...
           {
             if(hold[i]==Processes[j][0] && Processes[j][10]<Processes[0][7]&&Processes[j][11]<Processes[0][8]&&Processes[j][12]<Processes[0][9])
              {
